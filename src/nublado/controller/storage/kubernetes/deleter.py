...
class KubernetesObjectDeleter[T: KubernetesModel](KubernetesObjectCreator[T]):
    ...
    `~nublado.controller.storage.kubernetes.creator.KubernetesObjectCreator`
    primarily to avoid having to implement the list and delete methods in the
    mock for every object type we manage, even if we never call list and
    delete.
