...
from ...constants import ARGO_CD_ANNOTATIONS, FSADMIN_POD_NAME
...
class FSAdminBuilder:
    ...
    def _build_metadata(self, suffix: str = "") -> V1ObjectMeta:
    ...
    def _build_pvcs(self, username: str) -> list[V1PersistentVolumeClaim]:
        ...
        for volume in volumes:
            ...
            pvc = V1PersistentVolumeClaim(
                metadata=self._build_metadata(suffix=suffix),
